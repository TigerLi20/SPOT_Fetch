...
from multi_object_search.models.transition_model import *
from multi_object_search.models.observation_model import *
from multi_object_search.models.reward_model import *
from multi_object_search.models.policy_model import *
...
class MosAgent(pomdp_py.Agent):
    ...
    def __init__(
        ...
        # policy_model = PolicyModelLook(self.robot_id)
        super().__init__(
            init_belief,
            policy_model,
