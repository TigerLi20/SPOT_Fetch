...
MoveEast = MotionAction(
    MotionAction.EAST, scheme=MotionAction.SCHEME_XYTH, motion_name="East"
)
MoveWest = MotionAction(
    MotionAction.WEST, scheme=MotionAction.SCHEME_XYTH, motion_name="West"
)
MoveNorth = MotionAction(
    MotionAction.NORTH, scheme=MotionAction.SCHEME_XYTH, motion_name="North"
)
MoveSouth = MotionAction(
    MotionAction.SOUTH, scheme=MotionAction.SCHEME_XYTH, motion_name="South"
)

MoveForward = MotionAction(
    MotionAction.FORWARD, scheme=MotionAction.SCHEME_VW, motion_name="Forward"
)
MoveBackward = MotionAction(
    MotionAction.BACKWARD, scheme=MotionAction.SCHEME_VW, motion_name="Backward"
)
MoveLeft = MotionAction(
    MotionAction.LEFT, scheme=MotionAction.SCHEME_VW, motion_name="TurnLeft"
)
MoveRight = MotionAction(
    MotionAction.RIGHT, scheme=MotionAction.SCHEME_VW, motion_name="TurnRight"
)
