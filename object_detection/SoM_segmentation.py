...
def main():
    ...
    # image_path = "/home/xhe71/Downloads/1/Color/_Color_1730926876511.15258789062500.png"
    image_path = "./spot_util/hand_color_image.png"
    depth_image_path =  "./spot_util/hand_depth_image.png"
    
    data = run_segmentation(image_path, depth_image_path, transformation_matrix_path)
